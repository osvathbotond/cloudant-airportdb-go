...
func TestFindNearby_EmptyRepository(t *testing.T) {
	...
	results, err := f.FindNearby(context.Background(), 40.7128, -74.0060, 50)
...
func TestFindNearby_SortingByDistance(t *testing.T) {
	...
	results, err := f.FindNearby(context.Background(), 40.7128, -74.0060, 100)
...
func TestFindNearby_AllHubsWithinRadius(t *testing.T) {
	...
	results, err := f.FindNearby(context.Background(), 40.7128, -74.0060, 10)
...
func TestFindNearby_ZeroRadius(t *testing.T) {
	...
	results, err := f.FindNearby(context.Background(), 40.7128, -74.0060, 0)
...
func TestFindNearby_VeryLargeRadius(t *testing.T) {
	...
	results, err := f.FindNearby(context.Background(), 40.7128, -74.0060, 10000)
...
func TestFindNearby_BoundaryCase(t *testing.T) {
	...
	results1, err := f.FindNearby(context.Background(), 40.7128, -74.0060, 50.5)
	if err != nil {
		t.Errorf("Expected no error, got: %v", err)
	}
	if len(results1) != 1 {
	...
	results2, err := f.FindNearby(context.Background(), 40.7128, -74.0060, 49.5)
	if err != nil {
		t.Errorf("Expected no error, got: %v", err)
	}
	if len(results2) != 0 {
...
func TestFindNearby_NegativeCoordinates(t *testing.T) {
	...
	results, err := f.FindNearby(context.Background(), -33.8688, 151.2093, 50)
...
func TestFindNearby_DateLineProximity(t *testing.T) {
	...
	results, err := f.FindNearby(context.Background(), 0.0, 180.0, 200)
...
func TestFindNearby_PolarRegions(t *testing.T) {
	...
	results, err := f.FindNearby(context.Background(), 90.0, 0.0, 100)
